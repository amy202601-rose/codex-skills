---
name: wfs-marketing-pb-youtube-en
description: Convert an English Wallace Wang finance YouTube long-video oral script into publish-ready English marketing fields, format the script for readability without changing any words, choose English finance tags from the existing preferred tag pool, and write the issue into the WWFS Marketing publish center under "YouTube长视频". Use when the user provides an English YouTube long-video script or text and says "英文YouTube长视频写入YouTube长视频", "English YouTube long video to YouTube长视频", "英文长视频写入YouTube长视频", "写入YouTube长视频", "publish to YouTube长视频", "新建英文长视频一期", or asks to create English title/cover title/tags/description for marketing.wallacewang.ca/publish.
---

# WFS Marketing PB YouTube EN

Use this skill to turn an English Wallace Wang finance YouTube long-video script into a new `YouTube长视频` issue in the WWFS Marketing publish center.

## Inputs

- English YouTube long-video oral script: usually a `.txt` file path or pasted transcript.
- Title rules:
...
- Destination phrase: when the user says `英文YouTube长视频写入YouTube长视频`, `English YouTube long video to YouTube长视频`, or `写入YouTube长视频`, create or update an issue for the `YouTube长视频` IP.
